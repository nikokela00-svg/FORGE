...
export function BootScreen() {
  return (
    <main className="bg-background text-foreground relative flex min-h-dvh flex-col items-center justify-center">
      ...
      <footer className="text-foreground-muted absolute inset-x-0 bottom-6 text-center font-mono text-xs sm:text-sm">
        v0.1.0 — foundation
      </footer>
    </main>
  );
